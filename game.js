...
// Phaser namespace check for Jekyll static sites
(function() {
    if (typeof Phaser === "undefined") {
        window.alert("Phaser library not found. Please load Phaser.js before game.js!");
        return;
    }
    ...
    class TypingGame extends Phaser.Scene {
        ...
        createUI() {
            ...
            this.playerHealthText = this.add.text(150, 120, `${this.playerHealth}/${gameState.maxPlayerHealth}`, {
                fontSize: "12px",
                fill: "#fff",
                fontFamily: "Courier New"
            }).setOrigin(0.5);
            ...
            this.levelText = this.add.text(150, 180, `LV: ${gameState.playerLevel}`, {
                fontSize: "14px",
                fill: "#e74c3c",
                fontFamily: "Courier New",
                fontStyle: "bold"
        ...
        updateWordDisplay() {
            this.wordContainer.removeAll(true); // Remove all children safely
